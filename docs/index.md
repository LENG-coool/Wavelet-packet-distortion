...
2. **随机畸变**：随机选取一个小波包节点，使用非线性函数进行扭曲处理。
3. **重构**：通过逆变换生成具有差异性的增强样本，实现数据集的动态平衡。

<img src="/zh Fig.1.png" style="width: 100%; " />
<p align="center" style="color: grey">小波包畸变过程图</p>
...
- **多样性**：不同于简单的复制，小波包畸变引入了**频域扰动**，增加了训练数据的多样性
...
- **链接**：[https://doi.org/10.1016/j.aei.2022.101535](https://doi.org/10.1016/j.aei.2022.101535)